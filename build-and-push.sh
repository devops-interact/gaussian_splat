...
echo -e "GPU Support: A100, A40, RTX 3090, RTX 4090, H100"
...
if [ ${PIPESTATUS[0]} -eq 0 ]; then
    ...
    echo -e "  │ GPU Type           │ A40 (48GB) or RTX 4090 (24GB) or H100        │"
    ...
    echo -e "  └────────────────────┴──────────────────────────────────────────────┘"
    echo ""
    echo -e "${BLUE}Supported GPUs:${NC}"
    echo -e "  • A100 (40/80GB) - sm_80 - Best for large jobs"
    echo -e "  • A40 (48GB)     - sm_86 - Great value, recommended"
    echo -e "  • RTX 4090 (24GB)- sm_89 - Fast, limited VRAM"
    echo -e "  • H100 (80GB)    - sm_90 - Overkill for most jobs"
    echo ""
