...
- **3D Viewer** — orbit, walk-through, measurement (optional mid-poly wireframe mesh snap), snapshot capture. Performance audit: [`docs/viewer-3d-performance-audit.md`](docs/viewer-3d-performance-audit.md).
