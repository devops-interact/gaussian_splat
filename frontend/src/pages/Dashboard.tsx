    ...
    <div className="space-y-6">
      ...
      {showCreate && (
        <motion.div
          ...
          className="rounded-xl border border-white/[0.08] bg-[#060606] p-4"
        >
          <form onSubmit={handleCreate} className="flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg bg-[#0a0a0a] border border-white/[0.08] text-white placeholder-gray-500 font-mono text-sm focus:border-[#35c889]/50 outline-none"
              autoFocus
            />
            <button
              type="submit"
              disabled={!newName.trim() || creating}
              className="px-4 py-2 rounded-lg bg-[#35c889] text-black font-mono font-medium disabled:opacity-50"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg border border-white/[0.08] text-gray-400 hover:text-white font-mono"
            >
              Cancel
            </button>
          </form>
              ...
              >
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <FolderOpen className="w-8 h-8 text-[#35c889]/50" />
                    <button
