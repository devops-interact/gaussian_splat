    ...
    <div className="space-y-6">
      ...
      {showCreate && (
        <motion.div
          ...
          className="rounded-xl border border-white/[0.08] bg-black p-4"
        >
          <form onSubmit={handleCreate} className="flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg bg-black border border-white/[0.08] text-white placeholder-gray-500 font-mono text-sm focus:border-[#efe752]/50 outline-none"
              autoFocus
            />
            <button
              type="submit"
