...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-neutral-950 p-4">
      ...
      >
        <ApiConfigBanner />
        <div className="rounded-2xl border border-white/[0.22] bg-neutral-950 p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-neutral-950 border border-white/[0.22] text-white placeholder-gray-600 focus:border-white/50 focus:ring-1 focus:ring-white/38 outline-none transition-all text-sm"
                required
              />
            </div>
            <div>
            ...
            <button
              type="button"
              onClick={fillDemo}
              className="w-full py-2.5 rounded-lg border border-white/42 bg-white/[0.06] text-white text-sm hover:bg-white/[0.12] transition-colors"
            >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3 rounded-lg bg-white text-black font-semibold hover:bg-neutral-200 disabled:opacity-50 transition-colors"
            >
