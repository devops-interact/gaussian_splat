...
export function Sidebar({ activeItem = 'projects', onNavigate, userEmail = '', onLogout }: SidebarProps) {
  ...
  return (
    <div className="w-64 bg-black flex flex-col h-full border-r border-white/[0.05] flex-shrink-0">
      <div className="p-6 flex flex-col h-full">
        ...
        >
          <div className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center mr-3 border border-white/[0.08]">
            ...
            return (
              <motion.button
                ...
                className={`flex w-full items-center px-4 py-3 rounded-lg font-mono text-sm transition-colors duration-200 ${
                  isActive
                    ? 'bg-[#efe752]/[0.08] text-[#efe752] border border-[#efe752]/[0.19]'
