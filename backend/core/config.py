...
QUALITY_PRESETS: Dict[QualityPreset, PresetConfig] = {
    QualityPreset.BALANCED: PresetConfig(
        name="Balanced",
        description="Solid quality (~30–50 min typical; scales with video length). Main train 15k iters + convert_3dgs up to 8k; denser than prior 12k/6.5k defaults.",
        fps=1.5,
        iterations=15000,
        resolution=1,
        init_frames_ratio=0.30,
        estimated_minutes=40,
        convert_3dgs_prune_ratio=0.59,
        convert_3dgs_refinement_cap=8000,
    ),
    QualityPreset.QUALITY: PresetConfig(
        name="Quality",
        description="Highest fidelity (~70–100+ min typical; main train 28k iters + up to 12k convert_3dgs, slightly more frames/sec). Long clips dominate wall time.",
        fps=2.25,
        iterations=28000,
        resolution=1,
        ...
        convert_3dgs_refinement_cap=12_000,
    ),
}
